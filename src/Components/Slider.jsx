...
function Slider() {
  ...
  return (
    <div>
      ...
      <div
        className="flex overflow-x-auto w-full px-14 py-6 scrollbar-hide scroll-smooth"
        ref={elementRef}
      >
        {movieList.map((item) => (
          <img
       ...
       object-left-top mr-5 rounded-md hover:border-[4px] border-gray-400 transistion-all duration-100 ease-in"
          />
        ))}
      </div>
    </div>
